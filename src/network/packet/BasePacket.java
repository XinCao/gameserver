...
public abstract class BasePacket {
    ...
    /**
     * Constructs a new packet with given type.<br> If this constructor is used,
     * then setOpcode() must be used just after it.
     *
     * @param packetType
     */
    ...
    /**
     * Sets opcode of this packet.<br> <font color='red'>NOTICE: </font> Use
     * only if BasePacket(PacketType) constructor was use
     *
     * @param opcode
     */
